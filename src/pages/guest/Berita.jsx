...
// import { ArrowBack, ArrowBackIos, ArrowLeft, ChevronLeft, ChevronRight } from '@mui/icons-material';
...
//   const years = [2022, 2021, 2020]; // Example years for the dropdown
...
//           <div>
//             <label htmlFor="tahun">Urutkan Berdasarkan</label>
//             <select value={sortBy} onChange={handleSortByChange} className='block w-full border-gray-300 rounded-md shadow-sm mb-5 p-2'>
//               <option value='popular'>Populer</option>
//               <option value='latest'>Terbaru</option>
//             </select>
//           </div>
            
//           <button  className="grid bg-primaryBlue text-white px-4 py-2 rounded-md hover:bg-ternaryBlue transition-colors duration-300 ease-in-out transform transition-transform duration-300 ease-in-out hover:-translate-y-1" type="button">Tampilkan</button>
...
//                 <li>
//                   <a href="#" class="flex items-center justify-center px-3 h-8 ms-0 leading-tight text-ternaryBlue bg-white border border-e-0 border-gray-300 rounded-s-lg hover:bg-gray-100 hover:text-gray-700">
//                     <ChevronLeft fontSize='medium' />
//                   </a>
//                 </li>
//                 <li>
//                   <a href="#" class="flex items-center justify-center px-3 h-8 leading-tight text-ternaryBlue bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">1</a>
//                 </li>
//                 <li>
//                   <a href="#" class="flex items-center justify-center px-3 h-8 leading-tight text-ternaryBlue bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">2</a>
//                 </li>
//                 <li>
//                   <a href="#" aria-current="page" class="flex items-center justify-center px-3 h-8 text-blue-600 border border-gray-300 bg-secondaryBlue hover:bg-blue-100 hover:text-blue-700 dark:border-gray-700 dark:bg-gray-700 dark:text-white">3</a>
//                 </li>
//                 <li>
//                   <a href="#" class="flex items-center justify-center px-3 h-8 leading-tight text-ternaryBlue bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">4</a>
//                 </li>
//                 <li>
//                   <a href="#" class="flex items-center justify-center px-3 h-8 leading-tight text-ternaryBlue bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">5</a>
//                 </li>
//                 <li>
//                   <a href="#" class="flex items-center justify-center px-3 h-8 leading-tight text-ternaryBlue bg-white border border-gray-300 rounded-e-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">
//                     <ChevronRight />
//                   </a>
//                 </li>
//               </ul>
              ...
              {[...Array(totalPages)].map((_, index) => (
                <li key={index}>
                  <button
                    ...
                    className={`flex items-center justify-center px-3 h-8 leading-tight text-ternaryBlue bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 ${currentPage === index + 1 ? 'bg-gray-200' : ''}`}
                  >
                    {index + 1}
                  </button>
                </li>
