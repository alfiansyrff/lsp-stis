            ...
            <table className="w-full text-sm text-left text-ternaryBlue dark:text-gray-400 mb-5">
              <thead className="text-md text-center uppercase bg-ternaryBlue text-white">
                <tr>
                  ...
                  <th scope="col" className="px-6 py-3 rounded-tr-lg" style={{width:200}}>File</th>
                </tr>
              </thead>
                ...
                {[...Array(totalPages)].map((_, index) => (
                  <li key={index}>
                    <button
                      ...
                      className={`flex items-center justify-center px-3 h-8 leading-tight text-ternaryBlue bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 ${currentPage === index + 1 ? 'bg-[#D7EAFB] text-ternaryBlue' : ''}`}
                    >
                      {index + 1}
                    </button>
                  </li>
