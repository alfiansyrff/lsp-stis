...
// function HistorySertifikasi({successUpload}) {
//   return (
...
function HistorySertifikasi({ successUpload }) {
  ...
  useEffect(() => {
    if (successUpload) {
      // Perform any action needed when successUpload is true
          ...
          <div className="flex flex-col md:grid grid-cols-12 text-gray-50">
            ...
            {successUpload && (
              <div className="flex md:contents">
                ...
                <div className="bg-green-500 col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full">
                  <p className="font-semibold text-sm mb-1">Unggah bukti pembayaran</p>
                  <p className="leading-tight text-justify w-full text-[12px]">
                    21 Juli 2024, 12:45
                  </p>
                </div>
            ...
            <div className="flex md:contents">
              ...
              <div className={`col-start-4 col-end-12 p-4 rounded-xl my-4 mr-auto shadow-md w-full bg-gray-500`}>
                <p className="font-semibold text-sm mb-1">
                  {successUpload ? 'Menunggu konfirmasi admin' : 'Menunggu pembayaran'}
                </p>
                <p className="leading-tight text-justify w-full text-[12px]">
